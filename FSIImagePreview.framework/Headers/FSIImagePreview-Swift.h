...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FSIImagePreview",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC15FSIImagePreview17FSIViewController")
@interface FSIViewController : UIPageViewController
...
@interface FSIViewController (SWIFT_EXTENSION(FSIImagePreview)) <UIPageViewControllerDelegate>
...
@interface FSIViewController (SWIFT_EXTENSION(FSIImagePreview)) <UIPageViewControllerDataSource>
...
@interface FSIViewController (SWIFT_EXTENSION(FSIImagePreview))
