...
public class PreviewBar {
    ...
    init(on superview: UIView) {
        ...
        var statusBarTopAnchor: NSLayoutYAxisAnchor!
        if #available(iOS 11.0, *) {
            statusBarTopAnchor = statusBarFillingView.safeAreaLayoutGuide.topAnchor
        } else {
            statusBarTopAnchor = statusBarFillingView.topAnchor
        }
        NSLayoutConstraint.activate([
            ...
            statusBarFillingView.bottomAnchor.constraint(equalTo: statusBarTopAnchor)
        ])
